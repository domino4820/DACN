const MESSAGES = {
    ...
    groupNotOwner: 'Chỉ owner mới có quyền thực hiện hành động này',
    groupMemberNotFound: 'Thành viên không tồn tại trong nhóm',
    groupCannotKickSelf: 'Không thể kick chính mình',
    groupCannotTransferSelf: 'Không thể chuyển quyền cho chính mình',
